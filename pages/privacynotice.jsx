	...
	return (
		<>
			<div className="home-page-wrapper">
				<h1 className="text-center m-5">PRIVACY NOTICE</h1>
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Our&quot; in this Agreement) refers to Kindness Shake Incorporated, Darwin City NT 0800.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Country</strong> refers to: Northern Territory, Australia
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Kindness Shake, accessible from{" "}
							<a href="https://kindness-shake.com.au/" rel="external nofollow noopener" target="_blank">
								https://kindness-shake.com.au/
							</a>
						</p>
					</li>
					<li>
				...
				<ul>
					<li>
						...
						<a href="https://kindness-shake.com.au/privacynotice" rel="external nofollow noopener" target="_blank">
							https://kindness-shake.com.au/privacynotice
						</a>
					</li>
				</ul>
			</div>
