...
import { Button, Col, Form, Input, Radio, Row, Select, Switch, Upload } from "antd";
...
const doc = new GoogleSpreadsheet("1zMFH3Uy2hwZRUDgqvsANSQkX2bMgL3WqT9nF6wqtOHg");
...
const VolunteerForm = props => {
	...
	const sendEmail = e => {
		emailjs.send("service_ahbfe0g", "template_ypm8kd5", e, "user_ez3Faw0hPtbM3o6P3x5Nc").then(
			result => {
	...
	const getToken = async () => {
		await doc.useServiceAccountAuth({
			client_email: "volunteers-serviceaccount@volunteer-service-306610.iam.gserviceaccount.com",
			private_key:
		...
		<>
			<div className="home-page-wrapper">
				<Row align="middle" justify="center">
					...
					<Col xs={{ span: 20 }} lg={{ span: 8 }} className="m-2" align="middle" justify="center">
						<img
				...
				<div>
					<Col xs={{ span: 24 }} lg={{ span: 20 }} align="left" justify="center">
						{showConfetti ? (
							<Confetti
								width={width}
								height={height}
							...
							<Row align="middle" justify="center" className="mx-5">
								<Form
									...
									<Form.Item
										...
										<Select mode="multiple" placeholder="Please select your areas of expertise">
											<Option value="Administration">Administration</Option>
											<Option value="Event Management">Event Management</Option>
											<Option value="IT">IT</Option>
											<Option value="Logistics">Logistics</Option>
											<Option value="Marketing">Marketing, Communications and Media</Option>
