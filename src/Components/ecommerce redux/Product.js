...
import {Button, message, Modal, Rate, Tooltip} from "antd";
...
function Product({ data, className, type, countdownLast = 100000000 }) {
					...
					<div className={`product-tiny ${classNames(className)}`}>
						...
						<div className="product-tiny-content">
							...
							<h3 className="product-tiny-price">
								{data.discount ? formatCurrency(data.price - data.discount) : formatCurrency(data.price)}
						...
						<div className="product-dale-select">
							<Tooltip title="Add to wishlist">
								<Button
									...
									type="primary"
									shape="round"
									icon={addToWishlistLoading ? <LoadingOutlined spin /> : <i className="far fa-heart" />}
								/>
							</Tooltip>
							<Tooltip title="Add to cart">
								<Button
									...
									type="primary"
									shape="round"
									icon={addToCartLoading ? <LoadingOutlined spin /> : <i className="far fa-shopping-bag" />}
								/>
							</Tooltip>
				...
				return (
					<div className="product-list">
						...
						<div className="product-list-content">
							...
							<Rate className="product-rate" disabled defaultValue={data.rate} />
						...
						<div className="product-list-actions">
							...
							<h3 className="product-detail-content__price">
								...
								<div className="product-detail-content__price-discount">
									<h5>{data.discount ? formatCurrency(data.price - data.discount) : formatCurrency(data.price)}</h5>
								</div>
							</h3>
							<div className="product-detail-content__actions">
								<Button onClick={() => onAddToCart(data)} loading={addToCartLoading} shape="round">
									Add to cart
								</Button>
								<Button
									onClick={() => onAddToCompare(data)}
	...
	return (
		<>
			...
			<Modal visible={modalVisible} onCancel={onModalClose} footer={null} header={null} width={860}>
