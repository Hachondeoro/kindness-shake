	...
	return (
		<div className="product-detail-tab__reviews-item">
			<div className="product-detail-tab__reviews-item__avatar">
				<img src={process.env.PUBLIC_URL + data.user.avatar} alt="Customer avatar" />
		...
		<div className="product-detail-tab">
			<Tabs defaultActiveKey="1" type="card">
				<TabPane tab="Description" key="1">
					<div className="product-detail-tab__description">{fullDescription}</div>
				</TabPane>
						...
						<table>
							<tbody>
								...
								<tr>
									<td>Dimensions</td>
									<td>
										{specifications.dimensions.long} x {specifications.dimensions.width} x{" "}
