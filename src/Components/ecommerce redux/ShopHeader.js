...
import { setCurrentSort, setCurrentShow, setCurrentView } from "./redux/actions/shopFilterActions";
	...
	return (
		<div className="shop-header">
			...
			<div className="shop-header-selectors">
				<Select defaultValue="" style={{ width: 175 }} onChange={onSortSelectChange}>
				...
				<Select defaultValue="10" style={{ width: 115 }} onChange={onShowSelectChange}>
			...
			{!hideView && (
				<div className="shop-header-view">
					<a onClick={e => onViewChage(e, "grid")} className={classNames({ active: view === "grid" })} href="#">
						<i className="fas fa-th-large" />
					</a>
					<a onClick={e => onViewChage(e, "list")} className={classNames({ active: view === "list" })} href="#">
