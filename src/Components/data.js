export const Team = [
	{
		name: 'Benjamin Poveda-Alfonso',
		position: 'Co-Founder',
		image: '/static/img/ben.jpg',
		description:
			'Ben is passionate about multiculturalism, youth empowerment, community engagement and international education. Coming from a challenging Colombian background, he firmly believes that Education is the most potent weapon for changing the world. This is the reason why Ben has spent more than five years working to provide support to those who believe in a multicultural educated society.Ben’s contribution to the Northern Territory (NT) and the International Education industry has been outstanding and commenced immediately on his arrival in Australia in April 2015, to undertake his Bachelor of Accounting degree.'
	},
    {
		name: 'Ali Dhirani',
		position: 'Strategy, Governance and Administration',
		image: '/static/img/ali.jpg',
		description:
	...
	},
    {
		...
		position: 'Marketing, Communications and Media',
		image: '/static/img/manfred.jpg',
		description:
	...
	},
	{
		...
		position: 'Partnerships, Community Engagement and Fundraising',
		image: '/static/img/nilesh.jpg',
		description:
	...
	},
	{
		...
		position: 'Event Management and Logistics',
		image: '/static/img/kylie.jpg',
		description:
...
export const Instagram = [
	{ post: 'https://www.instagram.com/p/CL_T16fsgfu/' },
	{ post: 'https://www.instagram.com/p/CL5cb37ni5I/' },
	{ post: 'https://www.instagram.com/p/CL7t4AzHLZ-/' },
	{ post: 'https://www.instagram.com/p/CMDhiIVjUbH/' },
	{ post: 'https://www.instagram.com/p/CLEGNqOjn3-/' },
	{ post: 'https://www.instagram.com/p/CKgYqP2JC6y/' },
	{ post: 'https://www.instagram.com/p/CKd0k-zpaLv/' },
	{ post: 'https://www.instagram.com/p/CJHiY0qLQ66/' },
	{ post: 'https://www.instagram.com/p/CIuJdzGBwuF/' },
	{ post: 'https://www.instagram.com/p/CImBj5VBC2n/' },
	{ post: 'https://www.instagram.com/p/CIT6vfvAv77/' },
	{ post: 'https://www.instagram.com/p/CINWyi-sbAr/' },
	{ post: 'https://www.instagram.com/p/CIJuY0LAWlb/' }
]

export const BLBL = {
	title: 'Welcome to Be Local Buy Local ',
	description:
		'Be LOCAL & Buy LOCAL is an initiative aimed to support and establish an enduring relationship between local businesses and local community.',
	subtitle: 'How Be Local Buy Local works',
	steps: [
		{
			title: 'Step 1',
			subtitle: 'JOIN',
		...
		},
		{
			...
			subtitle: 'CHECK',
			description:
				'Check who are our partners where you can enjoy the discount '
		},
		{
			title: 'Step 3',
			subtitle: 'BUY',
			description: 'Buy the goods or services from our local business partners'
		},
		{
			title: 'Step 4',
			subtitle: 'SHOW',
			description:
				'To enjoy the discount, you need to present your membership card at the point of sale'
		},
		{
			title: 'Step 5',
			subtitle: 'PAY',
			description:
				'You must pay the difference between the total amount less the value of the discount. There is no minimum spending requirement to be eligible for discounts and the discounts vary at each participating merchants'
		}
	],
	footer:
	...
	logos: [
		{ path: '/static/img/belocal/Ana Nunex NAATI Translations.jpg',discount:'20% discount'},
		...
		{ path: '/static/img/belocal/Delicious Darwin.jpg' ,discount:'20% discount'},
		{ path: '/static/img/belocal/District North Kitchen Yarrawonga.jpg' ,discount:'10% discount'},
		...
		{ path: '/static/img/belocal/Johnn Johnns.jpeg' ,discount:'5%-10% discount'},
		{ path: '/static/img/belocal/Kcreative Graphic Designs.png' ,discount:'20% discount'},
		{ path: '/static/img/belocal/Lunch Room Catering.jpg' ,discount:'10% discount'},
		{ path: '/static/img/belocal/Night Market.JPG' ,discount:'10% discount'},
		{ path: '/static/img/belocal/Opium.jpg' ,discount:'10% discount'},
		{ path: '/static/img/belocal/Palates of India.jpg' ,discount:'10% discount'},
		{ path: '/static/img/belocal/PC Mart.png' ,discount:'5%-10% discount'},
		{ path: '/static/img/belocal/Psealms logo square.jpg' ,discount:'15% discount'},
		{ path: '/static/img/belocal/Rambha Noodle Bar.png' ,discount:'10% discount'},
		{ path: '/static/img/belocal/Regale Pizza Pasta.png' ,discount:'10% discount'},
		{ path: '/static/img/belocal/SAMAF Accountants & Consultants.png' ,discount:'20% discount'},
		{ path: '/static/img/belocal/Six Tanks.png' ,discount:'10% discount'},
		{ path: '/static/img/belocal/The Flank.jpg' ,discount:'10% discount'},
		{ path: '/static/img/belocal/Where 2 Buns Meat.png' ,discount:'10% discount'},
