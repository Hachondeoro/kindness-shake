const tryToEnableWACookies = (waUrl)  => {
			...
			if (oReq.status == 200) {
				if (oReq.responseText == 'disabled') {
					document.location.href =
						waUrl +
						'/Sys/Cookies/OpenAndClose?origin=' +
	...
	var testCookieName = 'WACookiesTestDonehttpsksiwildapricotorg'
...
export default tryToEnableWACookies
